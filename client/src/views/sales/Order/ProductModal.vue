<template>
    <div>
            <!--모달 안에 제품 목록 출력-->
        <input type="text" v-model="inputListsearch" class="text-center styled-input" placeholder="제품명 입력하세요"/>
        <div class="grid-container">
            <ag-grid-vue
            
            :rowData="rowData"
            :columnDefs="columnProductlist"
            :theme="theme"
            @grid-ready="onReady"
            :quickFilterText="inputListsearch"
            :noRowsOverlayComponent="noRowsOverlayComponent"
            @rowClicked="selectproduct"
            rowSelection="single" 
        />
        </div>
...
export default{
    ...
    methods: {
        async getEmpList(){
            ...
            this.rowData = result.data; //제품목록 저장
        },
