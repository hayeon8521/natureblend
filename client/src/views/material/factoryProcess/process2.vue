<template>
    <div class="d-flex flex-row mb-3">
        <div class="P-0" style="height: 110px; display: flex; justify-content: center; align-items: center;">
            <img src="http://yeonsus.com/academy/process2.gif" alt="병세척공정" height="75" width="75"/>
        </div>
        <div class="P-0">
            <div style="height: 150px; width: 190px;">
                <table class="table align-items-center text-center">
                    ...
                    <tr v-for="(cl, index) in process2_list.slice(0, 5)" :key="index">
...
<script setup>
    ...
    const { process2_list } = defineProps({
        process2_list: Array,
    });
</script>
